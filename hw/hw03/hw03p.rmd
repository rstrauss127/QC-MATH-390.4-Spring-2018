...
Are these metrics expected given the appropriate or relevant visualization(s) above?
Yes, there's not a strong relationship between the two.
...
For each unit increment in each x, the prcice will increase or decrease by the coressponding value of b
